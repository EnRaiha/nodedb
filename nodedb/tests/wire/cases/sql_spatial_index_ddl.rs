...
//! `CREATE SPATIAL INDEX` DDL acceptance and option validation: every
//! documented statement form is accepted, and every unsupported `USING` /
//! `PRECISION` / trailing-token shape is a rejection, not a silent fallback.
