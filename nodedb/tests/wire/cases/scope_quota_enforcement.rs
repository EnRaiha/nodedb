...
//! Per-scope token quotas: `DEFINE QUOTA` / `SHOW QUOTAS` / `DROP QUOTA`
//! create a durable catalog definition (survives a restart), a drop on an
//! undefined scope errors, and malformed definitions are refused outright.
