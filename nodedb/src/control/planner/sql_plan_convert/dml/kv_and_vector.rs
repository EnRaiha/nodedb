...
pub(in super::super) fn convert_kv_insert(
    ...
    for (key_val, value_cols) in entries {
        ...
        // registry here — the planner cannot run them. A NULL key marks the
        // "key column absent" case; a declared sequence default fills it,
        // otherwise the legacy empty key is stored.
