...
pub fn record(tenant_id: u64, collection: &str, purge_lsn: u64, catalog: &SystemCatalog) {
    if let Err(e) = catalog.record_wal_tombstone(tenant_id, collection, purge_lsn) {
        warn!(
            tenant_id,
