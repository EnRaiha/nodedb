...
//! MATCH query parsing entry points.

use super::super::ast::*;
use super::bindings;
use super::clauses::{parse_order_by, parse_return, parse_where};
use super::helpers::{
...
pub(in crate::engine::graph::pattern) fn parse_match_clauses(
    section: &str,
) -> crate::Result<Vec<MatchClause>> {
